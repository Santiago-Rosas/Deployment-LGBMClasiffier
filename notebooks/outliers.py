...
#fucntions to detect and repalce or remove outlier
...
##identifie the index of the outlier 
...
###create a table with the number of outlier per column 
...
###replace outlier with low limit or up_limit 
